                            ...
                            <li class="nav-item has-dropdown">
                                ...
                                <div class="dropdown">
                                    <ul class="list-unstyled">
                                       ...
                                       <li class="nav-item has-dropdown">
                                             <input id="header_product" type="checkbox" hidden="">
                                                 <a class="nav-link px-md-4 py-2"><label for="header_product"><?php echo app('translator')->getFromJson('site.liber-v'); ?></label></a>
                                                   <div class="dropdown">
                                                     <ul class="list-unstyled">
                                                         <li class="nav-item has-dropdown">
                                       ...
                                       <li class="nav-item has-dropdown">
                                             <input id="header_product" type="checkbox" hidden="">
                                                 <a class="nav-link px-md-4 py-2"><label for="header_product"><?php echo app('translator')->getFromJson('site.pura'); ?></label></a>
                                                   <div class="dropdown">
                                                     <ul class="list-unstyled">
                                                         <li class="nav-item has-dropdown">
