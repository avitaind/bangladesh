                        ...
                        <ul class="list-unstyled">
                            <li class="nav-item has-dropdown">
                                ...
                                <a class="nav-link px-md-4 py-2"><label for="header_product_liber"
                                        class="d-block mb-0"><?php echo app('translator')->getFromJson('site.laptops'); ?></label></a>
                                <div class="dropdown">
                                    <ul class="list-unstyled">
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link px-md-4 py-2"
                                                href="<?php echo e(route('product.overview', ['liber-new-generation'])); ?>"><?php echo app('translator')->getFromJson('site.liber'); ?></a>
                                        </li>
                                        ...
                                        <li class="nav-item has-dropdown">
                                            ...
                                            <div class="dropdown">
                                                <ul class="list-unstyled">
                                                    <li class="nav-item has-dropdown">
                                                        <a class="nav-link px-md-4 py-2"
                                                            href="<?php echo e(route('product.overview', ['liber-v-new-collection'])); ?>"><?php echo app('translator')->getFromJson('site.liber_v_new_collection'); ?></a>
                                                    </li>
                                                    <li class="nav-item has-dropdown">
                                                        <a class="nav-link px-md-4 py-2"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link px-md-4 py-2"
                                                href="<?php echo e(route('product.overview', ['liber-v-gold'])); ?>"><?php echo app('translator')->getFromJson('site.liber-v-gold'); ?></a>
                                        </li>

                                        <li class="nav-item has-dropdown">
                                            <input id="pura_product" type="checkbox" hidden="">
                                            <a class="nav-link px-md-4 py-2"><label
                                                    for="pura_product"><?php echo app('translator')->getFromJson('site.pura'); ?></label></a>
                                            <div class="dropdown">
                                                <ul class="list-unstyled">
                                                    <li class="nav-item has-dropdown">
                                                        <a class="nav-link px-md-4 py-2"
                                                            href="<?php echo e(route('product.overview', ['pura'])); ?>"><?php echo app('translator')->getFromJson('site.pura_intel'); ?></a>
                                                    </li>
                                                    <li class="nav-item has-dropdown">
                                                        <a class="nav-link px-md-4 py-2"
                                                            href="<?php echo e(route('product.overview', ['pura-amd'])); ?>"><?php echo app('translator')->getFromJson('site.pura_amd'); ?></a>
                                                    </li>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link px-md-4 py-2"
                                                href="<?php echo e(route('product.overview', 'magus12-2in1-laptop')); ?>"><?php echo app('translator')->getFromJson('magus.name'); ?></a>
                                        </li>
                            ...
                            <li class="nav-item has-dropdown">
                                ...
                                <a class="nav-link px-md-4 py-2"><label for="header_product_device"
                                        class="d-block mb-0"><?php echo app('translator')->getFromJson('site.accessories'); ?></label></a>
                                <div class="dropdown">
                                    <ul class="list-unstyled">
                                        <li class="nav-item">
                            ...
                            <li class="nav-item has-dropdown">
                                <input id="header_product_device" type="checkbox" hidden="">
                                <a class="nav-link px-md-4 py-2"><label for="header_product_device"
                                        class="d-block mb-0"><?php echo app('translator')->getFromJson('site.smart_device'); ?></label></a>
                                <div class="dropdown">
                                    <ul class="list-unstyled">
                                        <li class="nav-item">
                                            <a class="nav-link px-md-4 py-2"
                                                href="<?php echo e(route('product.overview', ['imago'])); ?>"><?php echo app('translator')->getFromJson('site.imago_series'); ?></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link px-md-4 py-2"
                                                href="<?php echo e(route('product.overview', ['modus'])); ?>"><?php echo app('translator')->getFromJson('site.modus_scale'); ?></a>
                                        </li>
                                    </ul>
                ...
                <?php if($shop_count >= 0): ?>
                    ...
                    <li class="nav-item has-dropdown">
                        ...
                        <a class="nav-link"><label
                                for="where_to_buy"><?php echo e(__('site.header_where_to_buy')); ?></label></a>

                        <div class="dropdown">
                            <ul class="list-unstyled">
                                <li class="nav-item">
                                    <a class="nav-link px-md-4 py-2"
                                        href="/where-to-buy"><?php echo e(__('site.offline_stores')); ?></a>
                                </li>
                                ...
                                <li class="nav-item has-dropdown">
                                    ...
                                    <a class="nav-link px-md-4 py-2"> <label for="header_buy_online"
                                            class="d-block mb-0"><?php echo e(__('site.buy_online')); ?></label></a>
