<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->getFromJson('title.LIBER_v_new_collection_home'); ?>
...
<style>
    ...
    <main class="top-nav-padding">
        ...
        <?php echo $__env->make('partials.liber-v-new-collection-navbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

        <section class="product-liber-banner">
            <div class="responsive-block">
                <div class="responsive-item">
                    <div class="banner-bg hidden-sm-down" style="background-image: url('/images/liber-v/liber_v_new_collection_intel_en.jpg')"></div>
                    <div class="banner-bg hidden-md-up" style="background-image: url('/images/liber-v/liber_v_new_collection_intel_en_mo.jpg')"></div>
        ...
        <section class="product-liber-video ls-0" style="background-color:#ebf3f5;">
                <div class="container">
                        <div class="space60"></div>
                         ...
                         <iframe src="https://www.facebook.com/v2.3/plugins/video.php?allowfullscreen=true&amp;autoplay=true&amp;container_width=800&amp;href=https%3A%2F%2Fwww.facebook.com%2FAVITAHongKong%2Fvideos%2F1087666314977158%2F" width="1100" height="620" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true"></iframe>
		...
		<!--
         <section class="product-liber-computer lLiberV_14colorss-0" id="test" style="background-color:#ebf3f5;">
                <div class="container">
                        <div class="space60"></div>
                        <div class="banner-para">
                        <div align="center" class="col-lg-12" >
                        	<div class="h2">全新上市</div>
                        </div>
                        <div class="banner-para text-center">
                            <span class="d-lg-block">
                            <a href="https://www.nexstmall.com/collections/avita-liber-v?utm_source=brandsite_medium=overview_campaign=buynow" target="_blank" style="color:#09F">立即購買 ></a>&nbsp;&nbsp; 
                            <a href="<?php echo e(route('product.map', 'liber-v')); ?>" style="color:#09F">銷售地點 ></a>
                            </span>
                        </div>
                        <div class="space60"></div>
                    </div>
        ...
        <section class="product-liber-computer product-liber-v-computer">
            <div class="banner-block">
                ...
                <div class="container">
							 ...
							 <span class="row mb-4 mt-5 text-left">
								...
								<div class="col-xs-12 col-md-7">
									...
									<span class="d-lg-block">	
										...
										Every year, the Red Dot Award is awarded to the year’s best products from more than 18,000 entries. Whether aesthetically appealing, functional, smart or innovative, what the award-winning objects have in common is their outstanding design quality. <br/>
										For more information, please visit <a href="https://www.red-dot.org/" target="_blank">www.red-dot.org</a>。
										</small>
									</span> 
								</div>
                    ...
                    <div class="banner-image">
                    	<img class="bc-computer-image bc-computer-1" src="/images/liber-v/Liber_v_new_collection_color_en.png">
                    </div>
         ...
         <section class="product-liber-performance product-liber-v-performance">
            <div class="banner-block"> 
                <div class="banner-image">
                    <img class="bc-computer-image bc-computer-1" src="/images/liber-v/AVITA_liber_v_new_collection_performance.jpg"> 
	                <img class="bc-computer-image fade-img" src="/images/liber-v/liber_v_new_collection_p02_en.png"> 
                </div>
                <div class="container">
                    <div class="banner-info">
                        <div class="ac-computer-wrap hidden-md-up">
                            <img class="ac-computer-image ac-computer-1" style="" src="/images/liber-v/AVITA_liber_v_new_collection_performance.jpg">
                        </div>
                        <div class="h1 mb-4">
       ...
       <section class="product-liber-banner product-liber-v-banner">
            <div class="responsive-block"> 
                <div class="banner-bg hidden-sm-down" style="background-image: url('/images/liber-v/liber_v_new_collection_amd_en.jpg')"></div>
                <div class="banner-bg hidden-md-up" style="background-image: url('/images/liber-v/liber_v_new_collection_amd_en_mo.jpg')"></div> 
            </div>
        </section>
            ...
            <div class="banner-block">
                ...
                <div class="container">
                    <div class="banner-info">
                        ...
                        <div class="h1 mb-4 mb-sm-5"><img src="/images/liber-v/icon_vision_1.png"><div class="d-sm-inline">Unbounded vision．Borderless bezel</div></div>
                        <div class="banner-para ls-0">
                            <span class="d-lg-block">LIBER V New Collection uses a 3.7mm borderless ultra-thin frame, installing a 13.3-inch body into a 14-inch screen, achieving a perfect 78.2% screen-to-body ratio. </span>
                            <span class="d-lg-block">With a 178-degree ultra-wide viewing angle and a full HD 16:9 IPS anti-glare LCD screen, the details on the screen are presented steadily and smoothly both indoors or outdoors. The meticulous viewing experience allows you to devote yourself to working, gaming and creating anytime, anywhere.</span>
                        </div> 
						<div class="banner-para ls-0"> 
                        </div> 
                    </div> 
        ...
        <section class="product-liber-performance product-liber-v-color">
            <div class="banner-block">
                <div class="banner-bg"></div>
                <div class="banner-image"> 
                    <img class="bc-computer-image bc-computer-1" src="/images/liber-v/AVITA_liber_v_new_collection_all.png"> 
                    ...
                    <img class="bc-computer-image fade-img-2" src="/images/liber-v/p05_new_collection.png"> 
				  	...
				  	<div class="banner-para ls-0 remark"> 
						<span class="d-md-block">
							<small>
								#Only applicable to specific colors and configurations. Only applicable to designated merchants.
							</small>
						</span>
					</div>
                ...
                <div class="container">
                    <div class="banner-info"> 
                        ...
                        <div class="h1 mb-4 mb-sm-5"><img src="/images/liber-v/icon_color_1.png"><div class="d-sm-inline">Endless colors．Unlimited matches</div></div>
        ...
        <section class="product-liber-performance product-liber-v-screen" style="background-color: transparent;">
            <div class="banner-block"> 
                ...
                <div class="container">
                    <div class="banner-info">
                        ...
                        <div class="h1 mb-4 mb-sm-5"><img src="/images/liber-v/icon_readily_1.png"><div class="d-sm-inline">Ultra-thin．Readily portable</div></div>
                        <div class="banner-para ls-0">
         ...
         <section class="product-liber-performance product-liber-v-io">
            <div class="banner-block">
                <div class="banner-bg"></div>
                <div class="banner-image">
                    <img class="bc-computer-1" src="/images/liber-v/AVITA_liber_v_new_collection_io.png" style="max-width: 100%;">  
                </div> 
            </div>
         </section>
