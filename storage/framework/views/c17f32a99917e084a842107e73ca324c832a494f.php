            ...
            <div class="country-box">
                <ul class="d-flex flex-column list-inline">
                   ...
                   <li class="list-inline-item p-1 mr-0">
                    ...
                    <li class="list-inline-item p-1 mr-0">
                        <a href="https://avita.com/country/sc" class="pl-5 py-2"><?php echo app('translator')->getFromJson('site.global_cn'); ?></a>
                    </li>
                    <li class="list-inline-item p-1 mr-0">
                        <a href="https://avita.com/country/tw" class="pl-5 py-2"><?php echo app('translator')->getFromJson('site.global_tw'); ?></a>
                    </li>
                    <li class="list-inline-item p-1 mr-0">
