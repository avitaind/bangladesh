...
class ProductsController extends Controller
{
    ...
    public function showProductFeatures($slug)
    {
        ...
        if ($slug == 'liber-v-new-collection') {

            switch ($country) {
                case 'bd':
                    return view('product.liber-v.liber-new-collection.feature_hk_en', compact('product'));
                    break;
            }
        }
        if ($slug == 'liber-v-amd') {
    ...
    public function showProductSpec($slug)
    {
        ...
        if ($slug == 'liber-v-new-collection') {
            switch ($country) {
                case 'bd':
                    return view('product.liber-v.liber-new-collection.spec_hk_en', compact('product'));
                    break;
            }
        }
