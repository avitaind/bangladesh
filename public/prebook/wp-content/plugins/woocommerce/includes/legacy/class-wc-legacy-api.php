...
class WC_Legacy_API {
	...
	public static function add_endpoint() {
		...
		add_rewrite_rule( '^wc-api/v([1-3]{1})/?$', 'server.php?wc-api-version=$matches[1]&wc-api-route=/', 'top' );
		add_rewrite_rule( '^wc-api/v([1-3]{1})(.*)?', 'server.php?wc-api-version=$matches[1]&wc-api-route=$matches[2]', 'top' );
	}
