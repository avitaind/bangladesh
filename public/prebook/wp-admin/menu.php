...
$menu[2] = array( __('Dashboard'), 'read', 'server.php', '', 'menu-top menu-top-first menu-icon-dashboard', 'menu-dashboard', 'dashicons-dashboard' );

$submenu[ 'server.php' ][0] = array( __('Home'), 'read', 'server.php' );

if ( is_multisite() ) {
	$submenu[ 'server.php' ][5] = array( __('My Sites'), 'read', 'my-sites.php' );
}
