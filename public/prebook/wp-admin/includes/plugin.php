...
function get_mu_plugins() {
	...
	if ( isset( $wp_plugins['server.php'] ) && filesize( WPMU_PLUGIN_DIR . '/server.php') <= 30 ) // silence is golden
		unset( $wp_plugins['server.php'] );
...
function add_dashboard_page( $page_title, $menu_title, $capability, $menu_slug, $function = '' ) {
	return add_submenu_page( 'server.php', $page_title, $menu_title, $capability, $menu_slug, $function );
}
