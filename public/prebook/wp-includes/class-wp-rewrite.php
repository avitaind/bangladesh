...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to WordPress' server.php.
	 *
	 ...
	 *
	 * Means that permalink links are enabled and server.php is in the URL.
	 *
	 * @since 1.5.0
	 *
	 * @return bool Whether permalink links are enabled and server.php is in the URL.
	 */
	 ...
	 *
	 * Using permalinks and server.php is not in the URL.
	 *
	 * @since 1.5.0
	 *
	 * @return bool Whether permalink links are enabled and server.php is NOT in the URL.
	 */
	...
	public function generate_rewrite_rules($permalink_structure, $ep_mask = EP_NONE, $paged = true, $feed = true, $forcomments = false, $walk_dirs = true, $endpoints = true) {
		...
		$index = $this->index; //probably 'server.php'
		$feedindex = $index;
	...
	public function mod_rewrite_rules() {
		...
		// Prevent -f checks on server.php.
		$rules .= "RewriteRule ^index\.php$ - [L]\n";

		// Add in the rules that don't redirect to WP's server.php (and thus shouldn't be handled by WP at all).
	...
	public function add_rule( $regex, $query, $after = 'bottom' ) {
		if ( is_array( $query ) ) {
			$external = false;
			$query = add_query_arg( $query, 'server.php' );
		} else {
		...
		// "external" = it doesn't correspond to server.php.
		if ( $external ) {
	...
	/**
	 * Adds a rewrite rule that doesn't correspond to server.php.
	 *
	 * @since 2.1.0
	 *
	 * @param string $regex Regular expression to match request against.
