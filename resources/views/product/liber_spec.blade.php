                    ...
                    <div class="container">
                        ...
                        <ul class="list-unstyled spec-list">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>7th Gen Intel® Core i5-8250U / Intel® Core i7-8550U</div>
                            </li>
                            <li class="spec-item d-flex">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>Cloud Silver, Shamrock Green, Matt Black,  Avita Purple, Champagne Gold, Ornament on Gold, Flowers on Yellow, Cherry Blossom Pink, Space Grey, Iris on Ruby</div>
                            </li>
