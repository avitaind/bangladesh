    ...
    <main class="top-nav-padding">
            ...
            <div class="container">
                ...
                <div class="product-nav-collapse">
                    <ul
                        ...
                        <!--  is liber-v-new-collection -->
                        <!--  end liber-v-new-collection -->
                        ...
                        <li class="nav-item"><a class="nav-link py-1"
                                href="https://www.avita.com/hk/product/liber-v-new-collection">Overview LIBER V New
                                Collection</a></li>

                        <li class="nav-item"><a class="nav-link py-1"
                                href="https://www.avita.com/hk/product/liber-v-new-collection/spec">Tech Spec</a></li>

                        <li class="nav-item"><a class="nav-link py-1"
                                href="https://www.avita.com/hk/product/liber-v-new-collection/support">Support</a></li>


                        <li class="nav-item">
                            <a class="nav-link py-1"
                                href="https://www.avita.com/hk/product/liber-v-new-collection/where_to_buy">Where to buy</a>
                        </li>
        ...
        {{-- <div class="product-fix-menu">
            ...
            <div class="menu-item">
                ...
                <a href="https://www.nexstmall.com/en?utm_source=brandsite&utm_medium=rightbutton&utm_campaign=buynow"
            ...
            <div class="menu-item">
                <a href="https://www.avita.com/hk/product/liber-v-new-collection/where_to_buy">Where<br /><small>to
                        buy</small></a>
            </div>
             ...
             <section class="product-liber-computer lLiberV_14colorss-0" id="test" style="background-color:#ebf3f5;">
                    <div class="container">
                            ...
                            <div class="banner-para text-center">
                                ...
                                <a href="https://www.avita.com/hk/product/liber-v/where_to_buy" style="color:#09F">銷售地點 ></a>
                                </span>
                            </div>
                            <div class="space60"></div>
                        </div>
